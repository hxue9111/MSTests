...
public class Sheets extends Activity
    ...
    final public static String EXTRA_VALUE = "cmsc436.mstests.VALUE";
    final public static String EXTRA_USER = "cmsc436.mstests.USER";
    final public static String EXTRA_TYPE = "cmsc436.mstests.TYPE";

    final private static String spreadsheetID = "1Nvpl_Vb4_RIgNAU2yHPIDy0JLvhcitfq47CBO7tmplw";
