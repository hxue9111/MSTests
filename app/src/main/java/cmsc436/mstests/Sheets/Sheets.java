package cmsc436.mstests.Sheets;
...
public class Sheets implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private final String SHARED_PREFS_NAME = "cmsc436.mstests.Sheets.Sheets";
    ...
    public Sheets(Host host, Activity hostActivity, String appName) {
        ...
        this.privateSpreadsheetId = "1Nvpl_Vb4_RIgNAU2yHPIDy0JLvhcitfq47CBO7tmplw";
    ...
    public enum TestType {
        ...
        LH_FLEX("'Flex Test (LH)'"),
        RH_FLEX("'Flex Test (RH)'"),
